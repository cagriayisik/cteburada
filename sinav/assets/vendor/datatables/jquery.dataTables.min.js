...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:5,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Sonraki Sayfa",sPrevious:"Önceki Sayfa"},sEmptyTable:"Herhangi bir veri bulunamadı...!",sInfo:"_TOTAL_ Kayıttan _START_ - _END_ Arası Gösteriliyor",sInfoEmpty:"Listede Kayıt Yok.",
sInfoFiltered:"(Toplamda _MAX_ kayıt tarandı...)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Sayfada _MENU_ Kayıt Göster",sLoadingRecords:"Loading...",sProcessing:"İşleniyor...",sSearch:"Arama:",sSearchPlaceholder:"ara...",sUrl:"",sZeroRecords:"Aramanız ile eşleşen bir kayıt bulunamadı!.."},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
